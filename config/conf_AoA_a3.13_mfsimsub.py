...
dlensalot_model = DLENSALOT_Model(
    ...
    simulationdata = DLENSALOT_Simulation(
        ...
        fnsnoise = {
            'E':'cmb-s4_nilc_EBresidual-noise_a{ai}latp{fg}_b02.50_ellmin70_2048_mc{{:03d}}.fits'.format(ai=ai, fg=fg),
            'B':'cmb-s4_nilc_EBresidual-noise_a{ai}latp{fg}_b02.50_ellmin70_2048_mc{{:03d}}.fits'.format(ai=ai, fg=fg)
        },
        fns = {
            'E':'cmb-s4_nilc_EBmap_a{ai}latp{fg}_b02.50_ellmin70_2048_mc{{:03d}}.fits'.format(ai=ai, fg=fg),
            'B':'cmb-s4_nilc_EBmap_a{ai}latp{fg}_b02.50_ellmin70_2048_mc{{:03d}}.fits'.format(ai=ai, fg=fg)
        },
        CMB_modifier = func,
