...
def func(data):
    ...
    print('======================')
    # TODO check if data should be multiplied by normalised rhits or rhits, looks like normalised should be used, see Shamiks posting: https://cmb-s4.atlassian.net/wiki/spaces/XC/pages/1436844034/Needlet+ILC+cleaned+maps+for+AoA+lensing+template+alternative+3
...
dlensalot_model = DLENSALOT_Model(
    ...
    simulationdata = DLENSALOT_Simulation(
        ...
        fns = {
            'E':'cmb-s4_hilc_EBmaps_a{ai}latp{fg}_beam02.50_ellmin70_2048_mc{{:03d}}.fits'.format(ai=ai, fg=fg),
            'B':'cmb-s4_hilc_EBmaps_a{ai}latp{fg}_beam02.50_ellmin70_2048_mc{{:03d}}.fits'.format(ai=ai, fg=fg)
        },
        CMB_modifier = func,
